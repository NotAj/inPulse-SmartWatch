...
public class pulseprotocol {
    ...
    // pulseprotocol stuff
    public static void writeInt32(int i, byte[] dest, int destOffset) 
    {
    ...
    public static void writeInt16(int i, byte[] dest, int destOffset) 
    {
        dest[destOffset++] = (byte) i;
        dest[destOffset] = (byte) (i >> 8);        
    }    
    public static void writeString(String text, byte[] dest, int destOffset)
    {
    ...
    public static byte[] encodeNotification(int type, String headerText, String bodyText)
    {
