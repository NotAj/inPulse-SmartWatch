...
r"""
This module implements the Pulse protocol, documented at
https://docs.google.com/a/pulse-dev.info/Doc?docid=0AczlKWqe6vYdZGZiNGh4cXdfOWdyaGptdmNx&hl=en
...
def notification(notification_type, alert_type=0, *args):
    r"""
    Returns a pulse message for a given notification.

    >>> notification(NotificationType.SMS, FLASH|VIBRATE, 'Bob', 'Hello')
    '\x04\x12\x01\x00\x01\x05\x04Bob\x00\x06Hello\x00'
    """
    # added the 0x000000
...
def command(id, para1, para2, data=""):
    cmd = struct.pack("<HII", id, para1, para2)
