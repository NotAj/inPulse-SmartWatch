...
#url = 'http://ec2-50-16-103-63.compute-1.amazonaws.com'
...
def resourceupload( cwd, inputfile ):
	...
	try:
		...
		print "upload failed, contact support@allerta.ca"
		exit()
	...
	while data.read() == "None" and counter < 30:
		...
		if counter >20:
			print "resource server is broken. please contact support@allerta.ca"
			exit()
